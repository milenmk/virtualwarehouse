...
llxHeader("", $langs->trans("AddStockToSalesRepresentative"));

print load_fiche_titre($langs->trans("AddStockToSalesRepresentative"), '', 'virtualwarehouse.png@virtualwarehouse');

echo $twig->render('form.addrecord.html.twig', ['obj' => $object, 'lang' => $langs]);

if (isset($_POST['add'])) {
    $object->insertVirtualStock(GETPOST('salesrep_select', 'int'), GETPOST('product_select', 'int'), GETPOST('qty_to_add', 'int'));
}
