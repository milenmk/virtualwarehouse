...
class modVirtualWarehouse extends DolibarrModules
{
    ...
    public function init($options = '')
    {
        ...
        //$result1=$extrafields->addExtraField('virtualwarehouse_myattr1', "New Attr 1 label", 'boolean', 1,  3, 'thirdparty',   0, 0, '', '', 1, '', 0, 0, '', '', 'virtualwarehouse@virtualwarehouse', '$conf->virtualwarehouse->enabled');
        //$result2=$extrafields->addExtraField('virtualwarehouse_myattr2', "New Attr 2 label", 'varchar', 1, 10, 'project',      0, 0, '', '', 1, '', 0, 0, '', '', 'virtualwarehouse@virtualwarehouse', '$conf->virtualwarehouse->enabled');
        //$result3=$extrafields->addExtraField('virtualwarehouse_myattr3', "New Attr 3 label", 'varchar', 1, 10, 'bank_account', 0, 0, '', '', 1, '', 0, 0, '', '', 'virtualwarehouse@virtualwarehouse', '$conf->virtualwarehouse->enabled');
        //$result4=$extrafields->addExtraField('virtualwarehouse_myattr4', "New Attr 4 label", 'select',  1,  3, 'thirdparty',   0, 1, '', array('options'=>array('code1'=>'Val1','code2'=>'Val2','code3'=>'Val3')), 1,'', 0, 0, '', '', 'virtualwarehouse@virtualwarehouse', '$conf->virtualwarehouse->enabled');
        //$result5=$extrafields->addExtraField('virtualwarehouse_myattr5', "New Attr 5 label", 'text',    1, 10, 'user',         0, 0, '', '', 1, '', 0, 0, '', '', 'virtualwarehouse@virtualwarehouse', '$conf->virtualwarehouse->enabled');
