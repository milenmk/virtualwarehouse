...
echo $twig->render('list.table.header.html.twig', ['obj' => $object, 'lang' => $langs]);
echo $twig->render('list.table.content.html.twig', ['obj' => $object, 'lang' => $langs, 'url' => DOL_URL_ROOT, 'srug' => $SalesRepUserGroup]);
echo $twig->render('list.table.footer.html.twig');
