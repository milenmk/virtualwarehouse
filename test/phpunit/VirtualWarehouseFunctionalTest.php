...
/**
 * \file    test/phpunit/VirtualWarehouseFunctionalTest.php
...
/**
 * Class VirtualWarehouseFunctionalTest
 *
 ...
 *
 * @package Testvirtualwarehouse
 */
class VirtualWarehouseFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modVirtualWarehouse')->click();
		} else {
			// Disable the module
			$this->byHref('modVirtualWarehouse')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/virtualwarehouse/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('virtualwarehouse/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/virtualwarehouse/admin/about.php');
		$this->authenticate();
		return $this->assertContains('virtualwarehouse/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('virtualwarehousewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modVirtualWarehouse_VirtualWarehouseTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modVirtualWarehouse_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
